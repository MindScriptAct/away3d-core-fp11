package away3d.primitives
{
	...
	public class WireframeTrident extends SegmentSet
	{
		 ...
		 */
		public function WireframeTrident(size : uint = 100, thickness : Number = 2, showLetters : Boolean = true, showNegative : Boolean = false, markGaps : Number = 0, colorX : uint = 0x0000FF, colorY : uint = 0xFF0000, colorZ : uint = 0x00FF00)
		{
			super();
